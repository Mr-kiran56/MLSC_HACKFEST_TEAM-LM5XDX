...
const translations = {
 ...
 [Language.HINDI]: {
  appName: 'किसान मित्र',
  appSubtitle: 'एआई वॉयस असिस्टेंट',
  ready: 'तैयार',
  liveAssistant: 'लाइव सहायक',
  configuration: 'सेटिंग्स',
  imageAnalysis: 'छवि विश्लेषण',
  uploadFarmImage: 'खेत की तस्वीर अपलोड करें',
  clickToUpload: 'खेत की तस्वीर अपलोड करने के लिए क्लिक करें',
  supportsFormat: 'JPG, PNG केवल 5MB तक',
  imageReady: 'तस्वीर विश्लेषण के लिए तैयार है',
  yourQuestion: 'आपका प्रश्न',
  questionPlaceholder: 'कीट, रोग, फसल स्वास्थ्य, मिट्टी की स्थिति के बारे में पूछें...',
  language: 'भाषा',
  topic: 'विषय',
  analyzeImage: 'तस्वीर का विश्लेषण करें',
  analyzing: 'विश्लेषण हो रहा है...',
  endVoiceCall: 'वॉयस कॉल समाप्त करें',
  startVoiceAssistant: 'वॉयस सहायक शुरू करें',
  analysisResult: 'विश्लेषण परिणाम',
  expertConversation: 'विशेषज्ञ बातचीत',
  geminiLive: 'जेमिनी प्रो लाइव',
  live: 'लाइव',
  startConversation: 'बातचीत शुरू करें या तस्वीर अपलोड करें',
  askAboutCrops: 'फसलों, कीटों के बारे में पूछें या खेत की तस्वीर अपलोड करें',
  analyzeThisUploadedImage: 'अपलोड की गई तस्वीर का विश्लेषण करें',
  connectToStart: 'शुरू करने के लिए कनेक्ट करें',
  startSpeaking: 'बोलना शुरू करें',
  farmerLanguage: 'किसान की भाषा',
  topicFocus: 'विषय फोकस',
  ...
  weatherSms: 'मौसम एसएमएस',
  currentCrop: 'वर्तमान फसल',
  expectedDate: 'अनुमानित तिथि',
  editProfile: 'प्रोफाइल संपादित करें',
  cropInfo: 'फसल जानकारी',
  daysRemaining: 'शेष दिन',
  smsNotEnabled: 'एसएमएस अलर्ट सक्षम नहीं हैं',
  enableSms: 'एसएमएस अलर्ट सक्षम करें',
  notifications: 'सूचनाएं'
},
[Language.TAMIL]: {
  appName: 'கிசான் மித்ரா',
  appSubtitle: 'AI குரல் உதவியாளர்',
  ready: 'தயார்',
  liveAssistant: 'நேரடி உதவியாளர்',
  configuration: 'அமைப்புகள்',
  imageAnalysis: 'பட பகுப்பாய்வு',
  uploadFarmImage: 'விவசாய படத்தை பதிவேற்றவும்',
  clickToUpload: 'விவசாய படத்தை பதிவேற்ற கிளிக் செய்யவும்',
  supportsFormat: 'JPG, PNG 5MB வரை மட்டுமே',
  imageReady: 'படம் பகுப்பாய்வுக்கு தயாராக உள்ளது',
  yourQuestion: 'உங்கள் கேள்வி',
  questionPlaceholder: 'பூச்சிகள், நோய்கள், பயிர் நிலை, மண் பற்றிக் கேளுங்கள்...',
  language: 'மொழி',
  topic: 'தலைப்பு',
  analyzeImage: 'படத்தை பகுப்பாய்வு செய்யவும்',
  analyzing: 'பகுப்பாய்வு நடைபெறுகிறது...',
  endVoiceCall: 'குரல் அழைப்பை முடிக்கவும்',
  startVoiceAssistant: 'குரல் உதவியாளரை தொடங்கவும்',
  analysisResult: 'பகுப்பாய்வு முடிவு',
  expertConversation: 'நிபுணர் உரையாடல்',
  geminiLive: 'ஜெமினி புரோ லைவ்',
  live: 'நேரடி',
  startConversation: 'உரையாடலை தொடங்குங்கள் அல்லது படம் பதிவேற்றுங்கள்',
  askAboutCrops: 'பயிர்கள், பூச்சிகள் பற்றி கேளுங்கள் அல்லது படம் பதிவேற்றுங்கள்',
  analyzeThisUploadedImage: 'பதிவேற்றிய படத்தை பகுப்பாய்வு செய்யவும்',
  connectToStart: 'தொடங்க இணைக்கவும்',
  startSpeaking: 'பேச தொடங்குங்கள்',
  farmerLanguage: 'விவசாயி மொழி',
  topicFocus: 'தலைப்பு கவனம்',
  ...
  smsNotEnabled: 'எஸ்எம்எஸ் எச்சரிக்கைகள் இயங்கவில்லை',
  enableSms: 'எஸ்எம்எஸ் எச்சரிக்கைகளை இயக்கு',
  notifications: 'அறிவிப்புகள்'
},
[Language.KANNADA]: {
  appName: 'ಕಿಸಾನ್ ಮಿತ್ರ',
  appSubtitle: 'AI ಧ್ವನಿ ಸಹಾಯಕ',
  ready: 'ಸಿದ್ಧ',
  liveAssistant: 'ಲೈವ್ ಸಹಾಯಕ',
  configuration: 'ಸೆಟ್ಟಿಂಗ್‌ಗಳು',
  imageAnalysis: 'ಚಿತ್ರ ವಿಶ್ಲೇಷಣೆ',
  uploadFarmImage: 'ಕೃಷಿ ಚಿತ್ರವನ್ನು ಅಪ್‌ಲೋಡ್ ಮಾಡಿ',
  clickToUpload: 'ಕೃಷಿ ಚಿತ್ರ ಅಪ್‌ಲೋಡ್ ಮಾಡಲು ಕ್ಲಿಕ್ ಮಾಡಿ',
  supportsFormat: 'JPG, PNG 5MB ವರೆಗೆ',
  imageReady: 'ಚಿತ್ರ ವಿಶ್ಲೇಷಣೆಗೆ ಸಿದ್ಧವಾಗಿದೆ',
  yourQuestion: 'ನಿಮ್ಮ ಪ್ರಶ್ನೆ',
  questionPlaceholder: 'ಕೀಟಗಳು, ರೋಗಗಳು, ಬೆಳೆ ಸ್ಥಿತಿ, ಮಣ್ಣಿನ ಬಗ್ಗೆ ಕೇಳಿ...',
  language: 'ಭಾಷೆ',
  topic: 'ವಿಷಯ',
  analyzeImage: 'ಚಿತ್ರ ವಿಶ್ಲೇಷಿಸಿ',
  analyzing: 'ವಿಶ್ಲೇಷಣೆ ನಡೆಯುತ್ತಿದೆ...',
  endVoiceCall: 'ಧ್ವನಿ ಕರೆ ಮುಗಿಸಿ',
  startVoiceAssistant: 'ಧ್ವನಿ ಸಹಾಯಕ ಪ್ರಾರಂಭಿಸಿ',
  analysisResult: 'ವಿಶ್ಲೇಷಣೆಯ ಫಲಿತಾಂಶ',
  expertConversation: 'ತಜ್ಞರ ಸಂಭಾಷಣೆ',
  geminiLive: 'ಜೆಮಿನಿ ಪ್ರೋ ಲೈವ್',
  live: 'ಲೈವ್',
  startConversation: 'ಸಂಭಾಷಣೆ ಪ್ರಾರಂಭಿಸಿ ಅಥವಾ ಚಿತ್ರ ಅಪ್‌ಲೋಡ್ ಮಾಡಿ',
  askAboutCrops: 'ಬೆಳೆಗಳು, ಕೀಟಗಳ ಬಗ್ಗೆ ಕೇಳಿ ಅಥವಾ ಚಿತ್ರ ಅಪ್‌ಲೋಡ್ ಮಾಡಿ',
  analyzeThisUploadedImage: 'ಅಪ್‌ಲೋಡ್ ಮಾಡಿದ ಚಿತ್ರ ವಿಶ್ಲೇಷಿಸಿ',
  connectToStart: 'ಪ್ರಾರಂಭಿಸಲು ಸಂಪರ್ಕಿಸಿ',
  startSpeaking: 'ಮಾತನಾಡಲು ಪ್ರಾರಂಭಿಸಿ',
  farmerLanguage: 'ರೈತ ಭಾಷೆ',
  topicFocus: 'ವಿಷಯ ಗಮನ',
  ...
  district: 'ಜಿಲ್ಲೆ',
  soilType: 'ಮಣ್ಣಿನ ವಿಧ',
  weatherSms: 'ಹವಾಮಾನ ಎಸ್ಎಮ್ಎಸ್',
  currentCrop: 'ಪ್ರಸ್ತುತ ಬೆಳೆ',
  expectedDate: 'ಅಂದಾಜು ದಿನಾಂಕ',
  editProfile: 'ಪ್ರೊಫೈಲ್ ಸಂಪಾದಿಸಿ',
  cropInfo: 'ಬೆಳೆ ಮಾಹಿತಿ',
  daysRemaining: 'ಉಳಿದ ದಿನಗಳು',
  smsNotEnabled: 'ಎಸ್ಎಮ್ಎಸ್ ಎಚ್ಚರಿಕೆಗಳು ಸಕ್ರಿಯವಿಲ್ಲ',
  enableSms: 'ಎಸ್ಎಮ್ಎಸ್ ಎಚ್ಚರಿಕೆಗಳನ್ನು ಸಕ್ರಿಯಗೊಳಿಸಿ',
  notifications: 'ಅಧಿಸೂಚನೆಗಳು'
},
[Language.MALAYALAM]: {
  appName: 'കിസാൻ മിത്ര',
  appSubtitle: 'AI വോയിസ് അസിസ്റ്റന്റ്',
  ready: 'തയ്യാർ',
  liveAssistant: 'ലൈവ് അസിസ്റ്റന്റ്',
  configuration: 'ക്രമീകരണങ്ങൾ',
  imageAnalysis: 'ചിത്ര വിശകലനം',
  uploadFarmImage: 'കൃഷി ചിത്രം അപ്‌ലോഡ് ചെയ്യുക',
  clickToUpload: 'കൃഷി ചിത്രം അപ്‌ലോഡ് ചെയ്യാൻ ക്ലിക്ക് ചെയ്യുക',
  supportsFormat: 'JPG, PNG 5MB വരെ',
  imageReady: 'ചിത്രം വിശകലനത്തിന് തയ്യാറാണ്',
  yourQuestion: 'നിങ്ങളുടെ ചോദ്യം',
  questionPlaceholder: 'കീടങ്ങൾ, രോഗങ്ങൾ, വിള നില, മണ്ണ് എന്നിവയെക്കുറിച്ച് ചോദിക്കുക...',
  language: 'ഭാഷ',
  topic: 'വിഷയം',
  analyzeImage: 'ചിത്രം വിശകലനം ചെയ്യുക',
  analyzing: 'വിശകലനം നടക്കുന്നു...',
  endVoiceCall: 'വോയിസ് കോളുകൾ അവസാനിപ്പിക്കുക',
  startVoiceAssistant: 'വോയിസ് അസിസ്റ്റന്റ് ആരംഭിക്കുക',
  analysisResult: 'വിശകലന ഫലം',
  expertConversation: 'വിദഗ്ധ സംഭാഷണം',
  geminiLive: 'ജെമിനി പ്രോ ലൈവ്',
  live: 'ലൈവ്',
  startConversation: 'സംഭാഷണം ആരംഭിക്കുക അല്ലെങ്കിൽ ചിത്രം അപ്‌ലോഡ് ചെയ്യുക',
  askAboutCrops: 'വിളകൾ, കീടങ്ങൾ എന്നിവയെക്കുറിച്ച് ചോദിക്കുക അല്ലെങ്കിൽ ചിത്രം അപ്‌ലോഡ് ചെയ്യുക',
  analyzeThisUploadedImage: 'അപ്‌ലോഡ് ചെയ്ത ചിത്രം വിശകലനം ചെയ്യുക',
  connectToStart: 'തുടങ്ങാൻ കണക്റ്റ് ചെയ്യുക',
  startSpeaking: 'സംസാരിക്കാൻ തുടങ്ങുക',
  farmerLanguage: 'കർഷക ഭാഷ',
  topicFocus: 'വിഷയ ശ്രദ്ധ',
  ...
  weatherSms: 'കാലാവസ്ഥ എസ்எമ്എസ്',
  currentCrop: 'നിലവിലെ വിള',
  expectedDate: 'പ്രതീക്ഷിക്കുന്ന തീയതി',
  editProfile: 'പ്രൊഫൈൽ തിരുത്തുക',
  cropInfo: 'വിള വിവരങ്ങൾ',
  daysRemaining: 'ബാക്കിയുള്ള ദിവസങ്ങൾ',
  smsNotEnabled: 'എസ்எമ്എസ് അലേർട്ടുകൾ പ്രവർത്തനക്ഷമമല്ല',
  enableSms: 'എസ்எമ്എസ് അലേർട്ടുകൾ പ്രവർത്തനക്ഷമമാക്കുക',
